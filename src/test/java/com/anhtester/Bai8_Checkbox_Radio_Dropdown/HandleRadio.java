...
public class HandleRadio {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        //Cuộn chuột đến cuối trang để thấy được các radio button
        ...
        System.out.println("Radio button 'Hours' is selected: " + radioHours);
        ...
        //Kiểm tra giá trị Radio select hay chưa
        boolean radioHoursAfterSelect = driver.findElement(By.xpath("//label[normalize-space()='Hours']/preceding-sibling::input")).isSelected();
        System.out.println("Radio button 'Hours' after selection: " + radioHoursAfterSelect);
