...
public class HandleCheckbox {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Click chon hoac ko chon checkbox
        Thread.sleep(500); // wait due to modal overlay intercept the click action. ??
        driver.findElement(By.xpath("//input[@id='task_is_public']")).click();

        Thread.sleep(1000);
        boolean checkboxPublicAfterSelected = driver.findElement(By.xpath("//input[@id='task_is_public']")).isSelected();
        System.out.println("Checkbox Public AFTER SELECTED: " + checkboxPublicAfterSelected);

//        driver.findElement(By.xpath("//input[@id='task_is_billable']")).click();
//        Thread.sleep(1000);
//        boolean checkboxBillableAfterUnselected = driver.findElement(By.xpath("//input[@id='task_is_billable']")).isSelected();
//        System.out.println("Checkbox Billable AFTER UNSELECTED: " + checkboxBillableAfterUnselected);
