...
public class DemoSoftAssert extends BaseTest {
    ...
    public void testSoftAssert() throws InterruptedException {
        ...
        softAssert.assertEquals(driver.getCurrentUrl(), "https://crm.anhtester.com/admin/", "URL is not correct");
        ...
        softAssert.assertEquals(headerText, "Customers Summary", "Header customer is not match");

        try{
            driver.findElement(By.xpath("//a[normalize-space()='New Customer']")).isDisplayed();
        }catch (Exception e) {
            softAssert.fail("Button Add new Customer does not displayed. Exception: " + e.getMessage());
        }
