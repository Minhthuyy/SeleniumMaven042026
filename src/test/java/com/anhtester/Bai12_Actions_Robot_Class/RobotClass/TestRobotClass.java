...
public class TestRobotClass extends BaseTest {
    ...
    @Test
    public void createScreenCapture() throws InterruptedException, AWTException {
    ...
    public void testGetPixelColor() throws AWTException {
        ...
        Robot robot = new Robot();
        robot.mouseMove(1527, 67);
        robot.delay(1000);

        String hexColor = ColorUtils.getHexColor(1527, 150);
        System.out.println("Màu pixel tại vị trí (1527, 67): " + hexColor);

        String hexColor2 = ColorUtils.getHexColor(1533, 63);
        System.out.println("Màu pixel tại vị trí (1533, 63): " + hexColor2);
