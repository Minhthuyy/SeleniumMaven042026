...
public class DemoAdvancedBrowser_Auto {
    public static void main(String[] args) throws InterruptedException {
        ...
        String expiryPart = cookieText.split("expires=")[1].split("GMT")[0];

        String result = expiryPart.substring(expiryPart.indexOf(",") + 2);

        System.out.println(result);

        //Format input
        DateTimeFormatter inputFormatter = DateTimeFormatter.ofPattern("dd 'thg' M yyyy HH:mm:ss",
        new Locale("vi", "VN")
        );
